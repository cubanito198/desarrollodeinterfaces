...
with mp_hands.Hands(
  ...
  while cap.isOpened():
    ...
    # Get image dimensions (height, width) for pixel conversion
    image_height, image_width, _ = image.shape  # Define image_width here
    ...
    if results.multi_hand_landmarks:
      for hand_landmarks in results.multi_hand_landmarks:
        ...
        if distance < 0.1:
            # Now that image_width and image_height are defined, you can convert to pixel coordinates
